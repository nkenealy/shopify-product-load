...
data =  json.dumps( {"sku": "CARACC01", "product_id": 4100, "title": "2006 Audi A6 Midsize Sedan"})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
data =  json.dumps({"sku": "CARACC02", "product_id": 4101, "title": "2006 BMW 5Series Midsize Sedan"})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
data =  json.dumps({"sku": "CARACC03", "product_id": 4102, "title": "2006 Cadillac STS Large Sedan "})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
