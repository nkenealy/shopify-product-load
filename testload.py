...
data =  json.dumps( {"productName": "2006 Audi A6 Midsize Sedan", "pos_product_id": 4100})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
data = json.dumps( {"productName": "2006 BMW 5Series Midsize Sedan", "pos_product_id": 4101})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
data =  json.dumps( {"productName": "2006 Cadillac STS Large Sedan", "pos_product_id": 4102, "title": "2006 Audi A6 Midsize Sedan"})
r = requests.post(github_url, data, headers=headers, auth=('neilkenealy@gmail.com', 'n3wmediam3d'))
print r.json
